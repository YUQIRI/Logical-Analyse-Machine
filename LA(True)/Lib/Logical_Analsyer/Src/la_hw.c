...
///* circle buffer def */
//#define LA_TIMOUT 10u
//#define LA_RX_BUFSIZE 500
...
//        HAL_UART_Transmit(&huart1, &sendata, 1, LA_TIMOUT);
//        return LA_OK;
...
//        HAL_UART_Transmit(&huart1, &sendata, 4, LA_TIMOUT);
//        return LA_OK;
...
//        HAL_UART_Transmit(&huart1, &sendata, strlen((const char *)&sendata), LA_TIMOUT);
//        return LA_OK;
